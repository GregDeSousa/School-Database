public class Main {
    ...
    public static void task1() throws DatabaseException {
        ...
        Node<Integer> x=treap1.access(12);
        System.out.println("NODE:" + x);
        System.out.println(validTreap(treap1));
        System.out.println(treap1.toString());
        for(int i=0;i<13;i++) {
            Node<Integer> t=treap1.access(0);
        ...
        for(int i=0;i<39;i++) {
            Node<Integer> t=treap1.access(2);
        ...
        System.out.println(validTreap(treap1));
        System.out.println(treap1.toString());
        Node<Integer> y=treap1.access(0);

        System.out.println("NODE:" + y);
        System.out.println(validTreap(treap1));
        System.out.println(treap1.toString());
        for(int i=0;i<50;i++) {
            Node<Integer> f=treap1.access(2);
            System.out.println("NODE:" + f);
            System.out.println(validTreap(treap1));
            System.out.println(treap1.toString());
            Node<Integer> j=treap1.access(0);
        ...
        for(int i=0;i<1000;i++) {
            Node<Integer> f=treap1.access(6);
            System.out.println("NODE:" + f);
            System.out.println(validTreap(treap1));
            System.out.println(treap1.toString());
            Node<Integer> j=treap1.access(1);
            System.out.println("NODE:" + j);
            System.out.println(validTreap(treap1));
            System.out.println(treap1.toString());
            for(int v=0;v<7;v++) {
                Node<Integer> g=treap1.access(9);
                System.out.println("NODE:" + g);
                System.out.println(validTreap(treap1));
                System.out.println(treap1.toString());
            }
            for(int z=0;z<58;z++) {
                Node<Integer> g=treap1.access(13);
                System.out.println("NODE:" + g);
                System.out.println(validTreap(treap1));
                System.out.println(treap1.toString());
            }
        ...
        /*for(int i=0;i<15;i++) {
            Node<Integer> t=treap1.access(3);
            System.out.println("NODE:" + t);
            System.out.println(validTreap(treap1));
            System.out.println(treap1.toString());
        }
        ...
        for(int i=0;i<1;i++) {
            Node<Integer> t=treap1.access(12);
            System.out.println("NODE:" + t);
            System.out.println(validTreap(treap1));
            System.out.println(treap1.toString());
        }
        ...
        for(int i=0;i<46;i++) {
            Node<Integer> t=treap1.access(13);
            System.out.println("NODE:" + t);
            System.out.println(validTreap(treap1));
            System.out.println(treap1.toString());
        }
    ...
    public static void task2() {
        ...
        try {
            String [][] find=db.findAllWhere("ession","Sem 3");
            if(find.length==0){
                System.out.println("ERROR:NOT FOUND");
            }else {
        ...
        try {
            //db.removeFirstWhere("Session","Sem 2");
            String [] update=db.updateFirstWhere("Module Code","WTW124","LST110");
            if(update.length==0){
                System.out.println("ERROR:NOT FOUND");
            }else {
                for(int j=0;j<db.columnNames.length;j++){
        ...
        try {
            String [][] update=db.updateAllWhere("Session","Sem 1","PPPPP");
            //String [][] find_2=db.removeAllWhere("Year","2");
            //String [][] find_3=db.removeAllWhere("Year","3");
            //String [][] find_4=db.removeAllWhere("Year","4");
            //String [][] find_5=db.removeAllWhere("Year","5");
